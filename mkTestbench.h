...
class MOD_mkTestbench : public Module {
 ...
 /* Module state */
 public:
  MOD_Reg<tUInt64> INST_dut_multiplicand64;
  MOD_Reg<tUInt32> INST_dut_multiplicand_twos;
  MOD_Reg<tUInt32> INST_dut_multiplier_twos;
  MOD_Reg<tUInt64> INST_dut_productReg;
  MOD_Reg<tUInt64> INST_dut_productResult;
  MOD_Reg<tUInt64> INST_dut_variables;
